...
``[options.entry_points]`` section in ``setup.cfg``::
    ...
    console_scripts =
         fibonacci = mexican_sign_language_toolkit.skeleton:run
...
# `from mexican_sign_language_toolkit.skeleton import fib`,
...
if __name__ == "__main__":
    ...
    #
    #     python -m mexican_sign_language_toolkit.skeleton 42
    #
    run()
